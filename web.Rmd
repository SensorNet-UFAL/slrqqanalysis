...
```
Based on <https://cran.r-project.org/web/packages/bibliometrix/vignettes/bibliometrix-vignette.html>, more details exploring the library bibliometrix can be found there.

### PDF
xxxx

## Processing data
Using `bibliometrix` package, the below gaphic can be visualized.
